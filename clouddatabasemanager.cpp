...
const QString CloudDatabaseManager::DB_HOST = "";
const QString CloudDatabaseManager::DB_NAME = "";
const QString CloudDatabaseManager::DB_USER = "";
const QString CloudDatabaseManager::DB_PASSWORD = "";
const int CloudDatabaseManager::DB_PORT = ;
// ------------ 请填写您自己数据库的相关信息----------------
